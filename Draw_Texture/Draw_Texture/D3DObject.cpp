...
D3DObject::D3DObject()
{
	...
	_look=D3DXVECTOR3(0.0f, -100.0f, -100.0f);//定个值
}
...
D3DXVECTOR3  D3DObject::GetPosistion(D3DXVECTOR3 _position)
{
	_position=v_Position;
	return _position;
}

void D3DObject::getLook(D3DXVECTOR3* look)
{
	*look = _look;
}
