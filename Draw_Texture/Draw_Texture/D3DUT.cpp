	...
	IDirect3DDevice9** device)
{
	...
	// Step 2: Check for hardware with vertex processing.
...
bool BoundingBox_1::isPointInside(D3DXVECTOR3& p)
{
...
BoundingSphere_1::BoundingSphere_1()
{
	_radius = 0.0f;
}
